				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<form class="row" action="../updateStatus" method="post">
							...
							<div class="col-md-6">
							    <br> <label>Specialist</label>
								<select name="spen">
									<option>--Please Select--</option>
									<%
										try{
											Class.forName("com.mysql.cj.jdbc.Driver");
											Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital", "root", "Sabya@1234");
											Statement st = con.createStatement();
											String que = "select spec_name from specialist";
								...
								<select name="medna">
									...
									<%
										try{
											...
											Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital", "root", "Sabya@1234");
											Statement st = con.createStatement();
											String que = "select med_name from medicine";
											ResultSet rs = st.executeQuery(que);
											while(rs.next()){
												%>
												<option>
